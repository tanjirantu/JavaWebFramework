...
public class Faculty implements Person {
    ...
    public void register(String organizationalId, String firstName, String lastName, String email, String address, String phoneNo, String password) {
    	DataAccess da = new DataAccess();	
 		...
 		da.updateQuery("insert into employees (organizational_id, first, last, email, address, phone, password) values('"+ organizationalId +"','"+ firstName +"','"+ lastName +"','"+ email +"', '"+ address +"','"+ phoneNo +"','"+ password +"')");	
    }
